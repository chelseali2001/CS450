...
const char *WINDOWTITLE = { "Project 4: Lighting -- Chelsea Li" };
...
Display( )
{
	...
	// setting up the first light (GL_LIGHT0)
	// attributes:
		// stationary
		// point light
		// white light
	...
	// setting up the second light (GL_LIGHT1)
	// attributes:
		// stationary
		// point light
		// red light
    ...
    glColor3f( 1., 0., 0. );
	OsuSphere( 0.05, 64., 64. );
	SetPointLight( GL_LIGHT1, -1., 1, -1, 1., 0., 0. );
    glPopMatrix( );

	// setting up the third light (GL_LIGHT2)
	// attributes:
		// moving
		// spot light
		// blue light
    ...
    glPushMatrix( );
    glTranslatef( cos(5*Time), -1, 0. );
    glColor3f( 0., 0., 1. );
    OsuSphere( 0.05, 64., 64. );
    SetSpotLight( GL_LIGHT2, cos(5*Time), -1, 0, -cos(5*Time), 1, 0., 0., 0., 1. );
    glPopMatrix( );
	...
	// attributes:
		...
		// sorta dull
		// smooth
		// textured (world map texture image)
		// white sphere
		// lighted
    ...
    glShadeModel( GL_FLAT );
	glPushMatrix( );
    SetMaterial( 1., 1., 0., 100. );
	glDisable( GL_TEXTURE_2D );
	glTranslatef( 0., 0., -1.8 );
    OsuSphere( 0.5, 64., 64. );
	glPopMatrix( );
	
	// setting up the third object
	// attributes:
		// moving
		// shiny
		// smooth
	...
	glPushMatrix( );
    SetMaterial( 0., 1., 0., 0. );
    glTranslatef( sin(5*Time), 1.25, 0. );
    OsuSphere( 0.5, 64., 64. );
	glPopMatrix( );
