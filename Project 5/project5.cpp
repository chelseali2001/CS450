...
const char *WINDOWTITLE = { "Project 5: Shaders -- Chelsea Li" };
...
GLuint	SphereList;				// list to hold the sphere
GLuint	CircleList;				// list to hold the circle
int		MainWindow;				// window id for main graphics window
float	Scale;					// scaling factor
float	Time;					// timer in the range [0.,1.)
int		Xmouse, Ymouse;			// mouse values
float	Xrot, Yrot;				// rotation angles in degrees
bool	ImUsingTheVertexShader, ImUsingTheFragmentShader;	// checking if a shader should be turned on or off
...
Display( )
{
	...
	Pattern->SetUniformVariable( "uA", A ); // value to set the coordinates of the 3D shape
	...
	Pattern->SetUniformVariable( "uB", B ); // value to set the color of the pattern
	Pattern->SetUniformVariable( "uTime", Time * 10 );
...
Keyboard( unsigned char c, int x, int y )
{
	...
	switch( c )
	{
		case 'b': // animate everything
			ImUsingTheVertexShader = true;
			ImUsingTheFragmentShader = true;
			break;
		case 'f': // freeze everything
			ImUsingTheVertexShader = false;
			ImUsingTheFragmentShader = false;
			break;
		case 'F': // freeze vertex shader
			ImUsingTheVertexShader = false;
			ImUsingTheFragmentShader = true;
			break;
		case 'V': // freeze fragment shader
			ImUsingTheVertexShader = true;
			ImUsingTheFragmentShader = false;
			break;
		case ESCAPE:
...
Reset( )
{
	...
	Scale  = 1.0;
	Xrot = Yrot = 0.;
	ImUsingTheVertexShader = ImUsingTheFragmentShader = true;
}
